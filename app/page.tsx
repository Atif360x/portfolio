  ...
  return (
    <main>
      <div className=" p-5 h-[100vh] w-[100vw] bg-linear-160 from-[#000]/20 to-[75%] to-[#000]">
        ...
        <h2 className="font-[Serif] flex justify-self-end text-right leading-none mix-blend-difference pt-[20vh] text-white text-[40px] font-bold md:w-[60vw] md:text-[70px] lg:w-[60vw] lg:text-[80px]">
